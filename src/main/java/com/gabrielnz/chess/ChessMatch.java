...
public class ChessMatch {
    ...
    public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition) {
        ...
        if (movedPiece instanceof Pawn) {
            if (movedPiece.getColor() == Color.WHITE && target.getRow() == 0 || movedPiece.getColor() == Color.BLACK && target.getRow() == 7) {
                ...
                promoted = replacePromotionPiece("Q");
    ...
    public ChessPiece replacePromotionPiece(String promotion) {
        if (promoted == null) {
            throw new IllegalStateException("There is no piece to be promoted");
        }
        if (!promotion.equals("B") && !promotion.equals("N") && !promotion.equals("Q") && !promotion.equals("R")) {
        ...
        ChessPiece newPiece = newPiece(promotion, promoted.getColor());
